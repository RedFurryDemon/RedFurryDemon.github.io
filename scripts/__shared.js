...
function displayHeader(headerText) {
	...
	header.innerHTML = `
		<div class="header_navbar">
			...
			<a class="link_button" href="_scratchpad.html">scratchpad</a>
			<a class="link_button" href="_resources.html">resources</a>
			<a class="link_button" href="_about.html">about</a>
		</div>
